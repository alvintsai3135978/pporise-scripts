name = "Farm Poke$ in Speciic map"
author = "Tester"
description = [[This script will catch shiny or rare Pokemon and will farm money in Speciic map.]]

mpaName = "Safari Zone" -- Change map name as you want.
X = 93 -- Choose a coordinate where people can't see you, choose big ammount like 150.
